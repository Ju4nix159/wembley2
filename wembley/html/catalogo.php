                        ...
                        <div class="col">
                            <div class="card h-100 bg-dark text-white">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <button class="btn btn-primary" data-producto-id="<?php echo $producto['id_producto']; ?>" data-producto-nombre="<?php echo $producto['nombre_producto']; ?>" data-producto-precio="<?php echo $producto['precio']; ?>">Añadir</button>
