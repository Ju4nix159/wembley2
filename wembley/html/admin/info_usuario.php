        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              < class="breadcrumb-item active">Info Personal</>
              </li>
                  ...
                  <tbody>
                    ...
                    foreach ($resultado_info_usuarios as $info_usuario) { ?>
                      <tr>
                        ...
                        <td> <?php echo $info_usuario['sexo'] ?> </td>
                ...
                <div class="card-body">
                  <table id="domicilio" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                      // Obtener datos de usuarios con el nombre del sexo
                      $sql_info_domicilio = $con->prepare("SELECT d.*, ud.tipo_domicilio FROM usuarios u JOIN info_usuarios iu ON u.id_usuario = iu.id_usuario JOIN domicilios_usuarios ud ON iu.id_info_usuario = ud.id_info_usuario JOIN domicilios d ON ud.id_domicilio = d.id_domicilio WHERE u.id_usuario = :id_usuario;
                    ");
                      ...
                      foreach ($resultado_info_domicilio as $info_dom) { ?>
                        <tr>
                          ...
                          <td> <?php echo $info_dom['codigo_postal'] ?> </td>
                          <td> <?php echo $info_dom['tipo_domicilio'] ?> </td>
                        </tr>
                      <?php } ?>
                    </tbody>
                    <tfoot>
